<?php  
$botToken = "6898920524:AAF7Cw91bTIUsruQw_t0hoZhp94KfNbj2S4"; // Enter ur bot token
$website = "https://api.telegram.org/bot".$botToken;
$bowner = "1814311243"; //owner
...
function getCards($text) {
    ...
    if (strlen($ano) != 2 && strlen($ano) != 4 || strlen($ano) == 2 && $ano < '23' || strlen($ano) == 4 && $ano < '2023' || strlen($ano) == 2 && $ano > '30' || strlen($ano) == 4 && $ano > '2030') {
        return;
    }
